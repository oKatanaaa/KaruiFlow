 ...
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ int                    min(int a, int b);
/**
 * \ingroup CUDA_MATH_INT
 ...
 * Calculate the minimum value of the arguments \p a and \p b.
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ unsigned int           umin(unsigned int a, unsigned int b);
/**
 * \ingroup CUDA_MATH_INT
 ...
 * Calculate the minimum value of the arguments \p a and \p b.
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ long long int          llmin(long long int a, long long int b);
/**
 * \ingroup CUDA_MATH_INT
 ...
 * Calculate the minimum value of the arguments \p a and \p b.
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ unsigned long long int ullmin(unsigned long long int a, unsigned long long int b);
 ...
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ int                    max(int a, int b);
 ...
 * Calculate the maximum value of the arguments \p a and \p b.
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ unsigned int           umax(unsigned int a, unsigned int b);
/**
 * \ingroup CUDA_MATH_INT
 ...
 * Calculate the maximum value of the arguments \p a and \p b.
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ long long int          llmax(long long int a, long long int b);
/**
 * \ingroup CUDA_MATH_INT
 ...
 * Calculate the maximum value of the arguments \p a and \p b.
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ unsigned long long int ullmax(unsigned long long int a, unsigned long long int b);
...
__MATH_FUNCTIONS_DEVICE_DECL__ float cyl_bessel_i0(float a);

__MATH_FUNCTIONS_DEVICE_DECL__ float cyl_bessel_i1(float a);
